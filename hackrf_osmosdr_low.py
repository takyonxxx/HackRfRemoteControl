...
class hackrf_osmosdr_low(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "hackrf_osmosdr_low")
        ...
        self.decimation = decimation = int(sample_rate/channel_width)
        ...
        self.rational_resampler_xxx_0 = filter.rational_resampler_ccc(
                interpolation=int(sample_rate/ 1e6),
                decimation=int(sample_rate*decimation / 1e6),
                taps=[],
                fractional_bw=0)
        ...
        # Connections
        ##################################################
        self.connect((self.analog_wfm_rcv_0, 0), (self.low_pass_filter, 0))
        self.connect((self.blocks_multiply_const_vxx_0, 0), (self.audio_sink, 0))
        self.connect((self.low_pass_filter, 0), (self.blocks_multiply_const_vxx_0, 0))
    ...
    def set_sample_rate(self, sample_rate):
        ...
        self.set_decimation(int(self.sample_rate/self.channel_width) )
        self.freq_sink.set_frequency_range(self.center_freq, self.sample_rate)
        self.low_pass_filter.set_taps(firdes.low_pass(1, self.sample_rate, self.channel_width, self.channel_width/12, window.WIN_HAMMING, 6.76))
...
def main(top_block_cls=hackrf_osmosdr_low, options=None):
