...
class hack_rf(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "hack_rf")
        ...
        self.soapy_hackrf_source_0 = soapy.source(dev, "fc32", 1, 'freq',
        ...
        self.soapy_hackrf_source_0.set_block_alias("HackRf Source")
...
def main(top_block_cls=hack_rf, options=None):
